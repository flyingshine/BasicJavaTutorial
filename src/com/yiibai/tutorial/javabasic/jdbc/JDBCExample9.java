...
//http://www.yiibai.com/jdbc/jdbc-streaming-data.html
...
public class JDBCExample9 {
	...
	static final String DB_URL = "jdbc:mysql://10.0.125.214/EMP";

	// Database credentials
	static final String USER = "sa";
	static final String PASS = "igen";
	...
	public static void main(String[] args) {
		...
		try {
			...
			File f = new File("f:\\XML_Data.xml");
